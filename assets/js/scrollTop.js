...
mybutton.onmouseenter = function() {this.innerHTML = icon1; console.log(this.onclick = topFunction)}
mybutton.onmouseleave = function() {this.innerHTML = icon2; console.log(this.onclick = topFunction)}
...
function topFunction() {
    window.scrollBy({
        top: -window.scrollY,
        left: 0,
        behavior: 'smooth' // You can change this to 'auto' or omit it for an instant scroll
      })
}